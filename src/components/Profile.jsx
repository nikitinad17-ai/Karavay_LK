import { useStore, currentOutletOf, lastOrderForOutlet } from '../store.jsx';
import { esc, fmtMoney, fmtMoneyShort, fmtDateShort, shipmentModeLabel, plural } from '../utils.js';
import { ShipmentPill } from './Pills.jsx';
import RecipientRow from './RecipientRow.jsx';
import { IconOutlets } from '../icons.jsx';
