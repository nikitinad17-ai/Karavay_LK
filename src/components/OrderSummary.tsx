...
import { esc, fmtMoney, fmtMoneyShort, fmtDateFull, groupLabel, outletMinSum } from '../utils';
import { ShipmentPill, BalancePill, EdiPill } from './Pills';
import type { CartItemView } from './OrderCatalog';
...
export default function OrderSummary({ cartItems, totalUnits, totalSum, belowMin, minSum }: OrderSummaryProps) {
